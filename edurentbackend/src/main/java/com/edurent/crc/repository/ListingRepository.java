...
public interface ListingRepository extends JpaRepository<ListingEntity, Long> {
        ...
        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.category LEFT JOIN FETCH l.user LEFT JOIN FETCH l.images WHERE l.user.userId = :userId")
        Page<ListingEntity> findByUserId(@Param("userId") Long userId, Pageable pageable);

        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.user LEFT JOIN FETCH l.category LEFT JOIN FETCH l.images WHERE l.user.userId = :userId AND l.status IN :statuses")
        ...
        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.user LEFT JOIN FETCH l.category LEFT JOIN FETCH l.images WHERE l.category.categoryId = :categoryId")
        Page<ListingEntity> findByCategoryId(@Param("categoryId") Long categoryId, Pageable pageable);

        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.user LEFT JOIN FETCH l.category LEFT JOIN FETCH l.images WHERE l.category.categoryId = :categoryId AND l.status IN :statuses")
        ...
        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.user LEFT JOIN FETCH l.category LEFT JOIN FETCH l.images WHERE l.status IN :statuses")
        Page<ListingEntity> findByStatusIn(@Param("statuses") List<String> statuses, Pageable pageable);

        @Query("SELECT l FROM ListingEntity l LEFT JOIN FETCH l.user LEFT JOIN FETCH l.category LEFT JOIN FETCH l.images WHERE l.listingType = :listingType AND l.status IN :statuses")
