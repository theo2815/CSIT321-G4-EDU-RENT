...
/**
 * A smooth, premium loading overlay with ripple animation.
 * Displays on top of the page content while keeping the background visible.
 * 
 * @param {boolean} isVisible - Controls whether the overlay is shown
 * @param {string} message - Optional message to display under the animation
 */
  ...
  return (
    <div className="loading-overlay">
      <div className="loading-overlay-content">
        {/* Ripple Loader Animation - Credit: Uiverse.io by Smit-Prajapati */}
